...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="top-info flex-grow-0">
                            ...
                            <div class="overflow-hidden" style="width: 735px;">
                                <div id="note" class="ps-2">
                                    <img src="img/anh1.jpg" class="img-fluid rounded-circle border border-3 border-primary me-2" style="width: 30px; height: 30px;" alt="">
                                    <a href="#"><p class="text-white mb-0 link-hover">Uy tín và chất lượng là thứ mà chúng tôi không có!</p></a>
                                </div>
                            </div>
                        </div>
                        <div class="top-link flex-lg-wrap">
                            <i class="fas fa-calendar-alt text-white border-end border-secondary pe-2 me-2"> <span class="text-body">Thứ 4, 16/4/2024</span></i>
        ...
        <!-- Hero Start -->
        <div class="container-fluid py-5 mb-5 hero-header" style="position: relative; overflow: hidden;">
            
            <img src="img/anh6.jpg" class="position-absolute top-0 start-0 w-100 h-100" alt="Background" style="object-fit: cover; filter: blur(5px); z-index: -1;">
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-md-12 col-lg-7">
                        ...
                        <div class="position-relative mx-auto">
                            <input class="form-control border-2 border-secondary w-75 py-3 px-4 rounded-pill" type="number" placeholder="Nhập sản phẩm ">
                        ...
                        <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active rounded">
                                    <img src="img/anh5.png" class="img-fluid w-100 h-100 bg-secondary rounded" alt="First slide">
                                    <a href="#" class="btn px-4 py-2 text-white rounded">Uy tín</a>
                                </div>
                                <div class="carousel-item rounded">
                                    <img src="img/anh2.jpg" class="img-fluid w-100 h-100 rounded" alt="Second slide">
                                    <a href="#" class="btn px-4 py-2 text-white rounded">Chất lượng</a>
                                </div>
                            </div>
            ...
            <div class="container py-5">
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="features-item rounded border bg-light d-flex align-items-center">
                            <div class="overflow-hidden mx-3" style="width: 100px; height: 100px;">
                                <img src="img/features-sports-1.jpg" class="img-zoomin img-fluid w-100 h-100 rounded-circle" alt="">
                            </div>
                            <div class="features-content text-start py-3">
